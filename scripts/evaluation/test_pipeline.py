...
def test_model_creation():
    ...
    try:
        ...
        print(f"[OK] Model created: {bilstm.__class__.__name__}")
        ...
        print("\n[OK] Model inference tests passed!")
...
def test_classification_pipeline():
    ...
    try:
        ...
        print(f"[OK] Pipeline initialized on device: cpu")
        ...
        print("\n[OK] Classification pipeline tests passed!")
        
    except Exception as e:
        print(f"\n[ERROR] Classification pipeline test failed: {e}")
        import traceback
        traceback.print_exc()
