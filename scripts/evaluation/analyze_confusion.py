...
from scripts.training.train_model_300 import BiLSTMSignClassifier, WLASLMPDataset, load_index_to_gloss
...
def main() -> None:
    ...
    parser.add_argument("--checkpoint", default="models/production/asl_wlasl300_realtime.pt")
